...
VVI_group = ["VVI"]
EEE_group = ["EEE"]
Dynamic_neigh_level = Enum('dynamic_neigh_level', ['domain', 'unit', "unit_freq_self", "unit_fix_domain", "unit_fix_domain_boundary", "unit_domain_boundary", "unit_img", "unit_img_sp", "unit_img_exp"])
